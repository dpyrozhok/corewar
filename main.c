...
//}
//
//char    *ft_check_name(char *name, t_label **all, t_my inf)
//{
//    t_label     *new_l;
//	int 		i;
//
...
//    if (!name)
//        return (NULL);
//    new_l = (t_label*)malloc(sizeof(t_label));
//	new_l->next = NULL;
//	ft_go_space(name, &inf.x);
//	while(name[i] != '\0' && name[++i] != ':')
//		inf.x++;
//	new_l->name = ft_strsub(name, 0, i);
//	if (name[i] != ':')
//		ft_printf("Lexical error[TOKEN][%i:%i]. Label should ends with ':' \n", inf.y, inf.x);
//	new_l->next = *all;
//	*all = new_l;
//	return (name);
//}
...
//    all = NULL;
//	inf.x = 0;
//    name = ft_check_name(inf.head->line, &all, inf);
////	ft_go_space(name, &inf.x);
//}
//
...
//        return(ft_printf("Source file name is not valid\n"));
//    else
